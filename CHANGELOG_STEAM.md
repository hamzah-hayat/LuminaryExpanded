...
[h2]Fixes[/h2]
[list]
[*] Fix the "The Crisis Averted" milestone event (paragon.5409) — its description was truncated mid-sentence and the accept option button was missing entirely, which left the event unreadable and effectively unresponsive when triggered.
[/list]
...
[h2]Features[/h2]
[list]
[*] Add AI-assisted localisation for nine additional languages: Brazilian Portuguese, French, German, Japanese, Korean, Polish, Russian, Simplified Chinese, and Spanish. Both the main loc file and the vanilla replace loc file are now translated for every supported language.
[/list]
